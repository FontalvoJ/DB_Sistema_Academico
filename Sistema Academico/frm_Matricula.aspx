                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-1 col-lg-1 d-flex align-items-center">
                                <div class="card-body p-3 p-lg-3 text-black">
                                    ...
                                    <h5 class="fw-normal mb-1 pb-1" style="letter-spacing: 1px;">Register Enrollment</h5>

                                    <form id="form1" runat="server">

                                        <div class="form-outline mb-2">
                                            <asp:TextBox ID="txt_idestudiante" runat="server" class="form-control form-control-sm" placeholder="Student Code"></asp:TextBox>
                                        </div>
